...
f.write("---------------------\n")
f = open("pypoll_results.txt", 'a')
f.write(f"Total Votes: {total_count}\n")
f = open("pypoll_results.txt", 'a')
f.write("---------------------\n")
f = open("pypoll_results.txt", 'a')
f.write(f"{candidates[0]}: {round(perc_0)}% ({count_0})\n")
f = open("pypoll_results.txt", 'a')
f.write(f"{candidates[1]}: {round(perc_1)}% ({count_1})\n")
f = open("pypoll_results.txt", 'a')
f.write(f"{candidates[2]}: {round(perc_2)}% ({count_2})\n")
f = open("pypoll_results.txt", 'a')
f.write(f"{candidates[3]}: {round(perc_3)}% ({count_3})\n")
f = open("pypoll_results.txt", 'a')
f.write("---------------------\n")
f = open("pypoll_results.txt", 'a')
